        ...
        <nav className="bg-white flex top-0 z-10 fixed w-full py-4 shadow">
            <section className="container flex justify-between items-center mx-auto">
                <section className="flex flex-row gap-10 items-center">
                    <Link href="/" className="font-bold text-2xl cursor-pointer">dormsphere.</Link>
                    <Link href="/" className="nav-menu">features <i className="fa-regular fa-chevron-right font-thin translate-y-0.5"></i></Link>
                    <Link href="/" className="nav-menu">pricing</Link>
                    <Link href="/" className="nav-menu">amenities</Link>
                </section>
